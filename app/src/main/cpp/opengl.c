...
Java_com_cxz_gifload_sample_GifHandle_openFile(JNIEnv *env, jobject thiz, jstring path_) {
    return openFile(env, thiz, path_);
}

JNIEXPORT jint JNICALL
Java_com_cxz_gifload_sample_GifHandle_getWidth(JNIEnv *env, jobject thiz, jlong gifInfo) {
    return getWidth(gifInfo);
}

JNIEXPORT jint JNICALL
Java_com_cxz_gifload_sample_GifHandle_getHeight(JNIEnv *env, jobject thiz, jlong gifInfo) {
    return getHeight(gifInfo);
}

JNIEXPORT jlong JNICALL
Java_com_cxz_gifload_sample_GifHandle_renderFrame(JNIEnv *env, jobject thiz, jlong gifInfo,
                                                  jobject bitmap) {
    return renderFrame(env, thiz, gifInfo, bitmap);
}
